...
public class GamePnael extends JPanel implements ActionListener {
	...
	public void drawUI(Graphics page) {
		...
		// DRAW score X
		ImageIcon xIcon = new ImageIcon("C:\\Users\\Stuff\\OneDrive\\Desktop\\TICTACTOEgame\\cross.png");
		...
		if (gameDone) {
			if (winner == 1) { // x
				page.drawString("The winner is", 310, 150);
                		// DRAW score 
		page.drawImage(newXIcon.getImage(), 335 ,160, null);
	...
	public void drawGame(Graphics page) {
		...
		ImageIcon newXIcon = new ImageIcon(newXImg);
		page.drawImage(newXIcon.getImage(), 30 + offset * i, 30 + offset * j, null);
				} else if (board[i][j] == 2) {
					page.setColor(offwhite);
	...
	public static void main(String[] args) {
		...
		GamePnael gamePanel = new GamePnael();
		frame.add(gamePanel);
